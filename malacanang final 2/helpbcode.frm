VERSION 5.00
Begin VB.Form helpbcode 
   BackColor       =   &H00800000&
   Caption         =   "Help - Barcode Search"
   ClientHeight    =   9720
   ClientLeft      =   2490
   ClientTop       =   630
   ClientWidth     =   14385
   ...
   Begin VB.Label Label2 
      Alignment       =   2  'Center
      BackColor       =   &H00800000&
      Caption         =   "THE BARCODE SEARCH WINDOW"
      BeginProperty Font 
         Name            =   "Comic Sans MS"
         Size            =   18
         Charset         =   0
   ...
   Begin VB.Image Image1 
      ...
      Height          =   5880
      Left            =   4320
      Picture         =   "helpbcode.frx":0995
      Stretch         =   -1  'True
      Top             =   840
      Width           =   5775
   End
End
Attribute VB_Name = "helpbcode"
